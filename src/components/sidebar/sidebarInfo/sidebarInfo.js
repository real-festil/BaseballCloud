      ...
      <>
        <div className="profile-info">
          ...
          <div className="profile-info__personal">
            ...
            <div className="profile-info__position">{position}</div>
            <div className="profile-info__position">{position2}</div>
          </div>
        </div>
        <ul className="profile-info__list">
          <li className="profile-info__item">
            ...
            <div className="profile-info__item-value">{age}</div>
          </li>
          <li className="profile-info__item">
            <div className="profile-info__item-name">
              <span className="profile-info__item-icon">
          ...
          <li className="profile-info__item">
            ...
            <div className="profile-info__item-value">{weight + " lbs"}</div>
          </li>
          <li className="profile-info__item">
            <div className="profile-info__item-name">
              <span className="profile-info__item-icon">
            ...
            <div className="profile-info__item-value">{throws_hand}</div>
          </li>
          <li className="profile-info__item">
            <div className="profile-info__item-name">
              <span className="profile-info__item-icon">
